<template>
  <div class="relative inline-flex border mr-5 px-3 rounded">
    <button
      ref="trigger"
      class="flex items-center justify-between btn min-w-44 bg-white border-slate-200 hover:border-slate-300 text-slate-500 hover:text-slate-600"
      ...
      <div v-show="dropdownOpen" class="z-10 absolute top-full left-0 w-full bg-white border border-slate-200 py-1.5 rounded shadow-lg overflow-hidden mt-1">
        ...
        >
          ...
          <button
            ...
            @click="selected = option; dropdownOpen = false"
          >
